...
In this Laravel Inertia project, use this skill for React component, hook, and
frontend utility tests. Use Pest for Laravel/PHP tests, browser tests, smoke
...
describe('UserList Component', () => {
    ...
    it('handles server error', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText(/error loading users/i),
            ).toBeInTheDocument();
        });
    });
});
...
**Compatible With**: Jest 29+, React Testing Library 13+, React 19 in this project
