# Shared Documentation Discipline
...
- Prefer Context7 for React, Motion, Radix, Tailwind, Jest, React Testing Library, user-event, jest-dom, and Vite frontend APIs.
- Use web search only when Boost and Context7 do not answer the question or the source is not covered by either.
- Prefer local conventions unless current version docs show the convention is unsafe, obsolete, inaccessible, or a performance risk.
