...
export function LegalFooter(): ReactElement {
    return (
        <footer className="flex flex-col items-center gap-1 border-t border-current/10 px-4 py-10 text-center text-sm text-(--color-muted-foreground) sm:px-6 lg:px-8">
